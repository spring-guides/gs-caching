...
(from `src/main/java/com/example/caching/Application.java`) shows how to do:

====
[source,java]
----
include::complete/src/main/java/com/example/caching/Application.java[]
----
====
...
The post-processor handlesthe  {Cacheable}[`@Cacheable`], {CachePut}[`@CachePut`] and
