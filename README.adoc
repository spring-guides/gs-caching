...
You can use this https://start.spring.io/#!type=gradle-project&jvmVersion=17&packaging=jar&groupId=com.example&artifactId=caching&packageName=com.example.caching&dependencies=cache[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
First, you need to create a simple model for your book. The following listing shows how to do so:
...
.Kotlin
----
include::initial-kotlin/src/main/kotlin/com/example/caching/Book.kt[]
----

== Create a Book Repository

You also need a repository for that model. The following listing shows such a repository:
...
.Kotlin
----
include::initial-kotlin/src/main/kotlin/com/example/caching/BookRepository.kt[]
----
...
(network service, slow delay, or other issues). The following listing shows such a repository:
...
.Kotlin
----
include::initial-kotlin/src/main/kotlin/com/example/caching/SimpleBookRepository.kt[]
----
...
.Kotlin
----
include::initial-kotlin/src/main/kotlin/com/example/caching/CachingApplication.kt[]
----
...
it several times with different arguments. The following listing shows that class:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/caching/AppRunner.kt[]
----
...
within the `books` cache. The following listing shows the repository definition:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/caching/SimpleBookRepository.kt[]
----
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/caching/CachingApplication.kt[]
----
